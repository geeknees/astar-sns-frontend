  ...
  return (
    <div className='flex justify-center items-center bg-gray-200 w-screen h-screen relative'>
      ...
      <main className='items-center h-screen w-1/3 justify-start flex bg-[#0090CD] flex-col'>
        <div className='z-10 h-screen w-1/3 bg-white absolute top-0 left-0' />
        <div className='z-10 h-screen w-1/3 bg-white absolute top-0 right-0' />
        <div className='z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute -top-24 left-[340px]' />
        <div className='z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute top-1/4 right-[300px]' />
        <div className='z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute -bottom-24 left-[330px]' />
